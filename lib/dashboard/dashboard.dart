...
import 'package:test_installasi_flutter/dashboard/SearchPage/SearchPage.dart';
          ...
          switch (index) {
            ...
            case 2:
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        BookmarkPage()), // Mengarahkan ke BookmarkPage
              );
              break;
            case 3:
              Navigator.push(
          ...
          Row(
            ...
            children: [
              ...
              Chip(
                label: Text('Clouds'),
                backgroundColor:
                    Color(0xFFb4badc), // Light blue chip background
                labelStyle: TextStyle(color: Colors.white), // White text
              ),
            ],
          ),
                ...
                Column(
                  children: [
                    Icon(Icons.water_drop,
                        color: Color(0xFF00A8E8)), // Blue icon
                    Text('Humidity',
                        style:
                            TextStyle(color: Color(0xFF00A8E8))), // Blue text
                    Text('32%',
                        style:
                            TextStyle(color: Color(0xFF00A8E8))), // Blue text
                  ],
